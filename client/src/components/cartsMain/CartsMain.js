                        ...
                        <Col lg={9}>
                            ...
                            <div>
                              ...
                              >
                                <Button
                                  ...
                                  variant="light"
                                  onClick={()=>handleDecrement(element.productDetails?._id)}
                                >
                                  &minus;
                                </Button>
                          ...
                          <div className="list-store d-flex align-items-center justify-content-between">
                            <div className="d-flex gap-2">
                              <Button
                                className="btn-list"
                                onClick={()=>handleRemoveItems(element.productDetails._id)}
                                variant="danger"
                                size="xsmall"
                              >
                            ...
                            <div className="d-flex">
                              <h5>Total :- { element.productDetails?.price * element?.quantity - (element.productDetails?.price * element?.quantity * element.productDetails?.discount /100)}</h5>
                            </div>
                          </div>
                        </Col>
                      </Row>
