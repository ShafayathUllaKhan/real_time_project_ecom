      ...
      <section>
                <div className="form_data">
                    ...
                    <form>
                        ...
                        <Form.Group className="mb-3 mt-2" onChange={handleChange} controlId="exampleForm.ControlTextarea1">
                                    <Form.Control as="textarea" value={inputvalue.address} name='address' placeholder='Shipping Address' rows={2} />
                                </Form.Group>
